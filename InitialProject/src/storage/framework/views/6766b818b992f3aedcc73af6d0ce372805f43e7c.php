...
<div class="container cardprofile">
            ...
            <div class="col-md-6" style="width:40%">
                <div class="card-body" style="width:auto">
                    ...
                    <h6 class="card-text1">Khon Kaen University</h6> -->
                        ...
                        <h6 class="card-text2 col-sm-10" style="line-height: 1.6;"> <?php echo e($edu->year); ?> <?php echo e($edu->qua_name); ?> <br> <?php echo e($edu->uname); ?></h6>
    ...
    <div class="nav-container">
        ...
        <a class="btn-export" href="<?php echo e(route('excel', ['id' => $res->id])); ?>" target="_blank" aria-label="Export to Excel">
            ...
            <table id="example1" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:90%;">
                            <a href="<?php echo e(route('paper.detail', ['id' => $paper->id, 'user_id' => $res->id ?? 999])); ?>" class="paper-link">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span>
                                <a href="<?php echo e(route('detail',Crypt::encrypt($author->id))); ?>">
                                    <teacher><?php echo e($author -> fname_en); ?> <?php echo e($author -> lname_en); ?></teacher>
                                </a>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WINDOWS\Documents\GitHub\git-group-repository-group-3-sec-2-v-2\InitialProject\src\resources\views/researchprofiles.blade.php ENDPATH**/ ?>