...
<div class="container home">
    ...
    <div class="container mixpaper pb-10 mt-3">
        ...
        <div class="accordion" id="accordion<?php echo e($n); ?>">
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading<?php echo e($n); ?>">
                    <button class="accordion-button collapsed" type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapse<?php echo e($n); ?>"
                        data-year="<?php echo e($n); ?>"
                        aria-expanded="false"
                        aria-controls="collapse<?php echo e($n); ?>">
                        <?php if(!$loop->last): ?>
                        <?php echo e($n); ?>
                ...
                <div id="collapse<?php echo e($n); ?>"
                    class="accordion-collapse collapse"
                    aria-labelledby="heading<?php echo e($n); ?>"
                    data-bs-parent="#accordion<?php echo e($n); ?>">
                    <div class="accordion-body">
                        <div class="papers-container" id="papers-<?php echo e($n); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WINDOWS\Documents\GitHub\git-group-repository-group-3-sec-2-v-2\InitialProject\src\resources\views/home.blade.php ENDPATH**/ ?>