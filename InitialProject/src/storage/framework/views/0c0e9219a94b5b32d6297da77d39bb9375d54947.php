...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            ...
            <a class="btn btn-primary btn-menu btn-icon-text btn-sm mb-3" href="<?php echo e(route('researchGroups.create')); ?>">
            ...
            <table id="example1" class="table table-striped">
                ...
                <tbody>
                    <?php $__currentLoopData = $researchGroups->filter(function($group) {
                        return $group->user->contains('id', Auth::id());
                    }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $researchGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WINDOWS\Documents\GitHub\git-group-repository-group-3-sec-2-v-2\InitialProject\src\resources\views/research_groups/index.blade.php ENDPATH**/ ?>