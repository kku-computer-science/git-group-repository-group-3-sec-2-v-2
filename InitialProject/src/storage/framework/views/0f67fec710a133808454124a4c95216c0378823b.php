            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('researchers.*') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('researchers.index')); ?>">
    ...
    <footer class="footer">
        <div class="container">
            <div class="text-center">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> College of Computing, Khon Kaen University. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\Users\WINDOWS\Documents\GitHub\git-group-repository-group-3-sec-2-v-2\InitialProject\src\resources\views/layouts/layout.blade.php ENDPATH**/ ?>