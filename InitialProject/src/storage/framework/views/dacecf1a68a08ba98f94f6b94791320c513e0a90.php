...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="validate-form" autocomplete="off">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\WINDOWS\Documents\GitHub\git-group-repository-group-3-sec-2-v-2\InitialProject\src\resources\views/auth/login.blade.php ENDPATH**/ ?>