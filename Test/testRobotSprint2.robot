...
Select User from DropDown1
    ...
    Wait Until Element Is Visible    xpath=//span[@id='select2-selUser5-container']    timeout=10s
    Click Element                    xpath=//span[@id='select2-selUser5-container']
    Sleep    1s  # รอให้ Drop Down แสดงผล
    Click Element                    xpath=//li[contains(@id, 'select2-selUser5-result') and contains(text(),'สิรภัทร เชี่ยวชาญวัฒนา')]
    Sleep    1s
...
TC007 Edit Research Groups1
    Wait Until Element Is Visible    xpath=//a[@href='https://sesec2group3.cpkkuhost.com/researchGroups/22/edit' and contains(@class,'btn-outline-success') and @title='Edit']    timeout=60s
    Scroll Element Into View        xpath=//a[@href='https://sesec2group3.cpkkuhost.com/researchGroups/22/edit' and contains(@class,'btn-outline-success') and @title='Edit']
    Click Element                    xpath=//a[@href='https://sesec2group3.cpkkuhost.com/researchGroups/22/edit' and contains(@class,'btn-outline-success') and @title='Edit']
    Sleep    2s
